...
public class AccessOrderBeans {
    ...
    public String getMakeServiceTime() {
        return makeServiceTime;
    }

    public void setMakeServiceTime(String makeServiceTime) {
        this.makeServiceTime = makeServiceTime;
    }
    ...
    public String getLastRelieveHuangUpTime() {
        return lastRelieveHuangUpTime;
    }

    public void setLastRelieveHuangUpTime(String lastRelieveHuangUpTime) {
        this.lastRelieveHuangUpTime = lastRelieveHuangUpTime;
    }

    public String getRelieveHangUpLongTime() {
        return relieveHangUpLongTime;
    }

    public void setRelieveHangUpLongTime(String relieveHangUpLongTime) {
        this.relieveHangUpLongTime = relieveHangUpLongTime;
    }

    public String getCauseHangUp() {
        return causeHangUp;
    }

    public void setCauseHangUp(String causeHangUp) {
        this.causeHangUp = causeHangUp;
    }
    ...
    public void setTerminalReceivePower(String getTerminalReceivePower) {
    ...
    //最后解挂时间
    private String lastRelieveHuangUpTime;
    //解挂历时
    private String relieveHangUpLongTime;
    //挂起原因
    private String causeHangUp;
    //订单编号
